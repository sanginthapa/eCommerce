...
echo $count;
?>
<div id="carouselItemCaptions" class="carousel slide" data-bs-ride="carousel">
...
while ($data = mysqli_fetch_assoc($req)) {
  // echo $data['img_path'].$data['img']."<br>";
  if ($i == 0) {
?>
    <div class="carousel-item active">
      <img src="<?php echo $data['img_path'] . $data['img']; ?>" class="d-block w-100">
