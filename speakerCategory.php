...
<div class="col-12">
  <div class="col-12">
    <img class="w-100" style="height:400px" src="assets\images\products\SW1 Speaker\Untitled-2.png" alt="offer zone">
  </div>
  <div>

    <div class="container text-left mt-5 mb-5">
      <div class="h1 fw-bolder text-white"> <span class="border-bottom border-3 px-3">Wareless Speaker</span></div>
    </div>
