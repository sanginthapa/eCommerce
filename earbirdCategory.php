...
<div class="col-12">
  <div class="col-12">
    <img class="w-100" style="height:400px" src="assets\images\page_banners\banner6.jpg" alt="offer zone">
  </div>
  <div>
    <div class="container text-left mt-5 mb-5">
      <div class="h1 fw-bolder text-white"> <span class="border-bottom border-3 px-3">Wireless Earbuds</span></div>
    </div>
...
//product card layout 
      ...
      <div class="card font-normal m-1 mt-3 mb-3 product-wrapper product-card-size text-start"
        ...
        <div class="col-5">
          <span style="background: #929292; color:white; position:absolute;">SoldOut</span>
        ...
        <div data-aos="zoom-in" data-aos-duration="2000">
          <a href="<?php echo $data['url_link']; ?>">
            <img class="change-on-hover<?php echo $data['id']; ?>" style="width:100%;z-index:1; opacity: 0.5;" src="<?php $img1 = $data['img_path'] . $data['primary_image'];
        ...
        <div class="card-body border border-2 rounded mx-2 mb-2 bg-white">
          <div class="card-title">
            <span><strong class="fw-bolder" type="<?php echo $data['product_name'] ?>">
            ...
            <a style="width:100%; background:white; color:red; border:1px solid red" class="btn text-center"
              data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-bs-whatever="@mdo">Notify Me</a>
          </div>
        </div>
      </div>
      ...
      <div class="card font-normal m-1 mt-3 mb-3 product-wrapper product-card-size text-start"
        ...
        <div data-aos="zoom-in" data-aos-duration="2000">
          <a href="<?php echo $data['url_link']; ?>">
            <img class="change-on-hover<?php echo $data['id']; ?>" style="width:100%;z-index:1;" src="<?php $img1 = $data['img_path'] . $data['primary_image'];
              echo $img1; ?>" class="card-img-top" alt="airdopes"></a>
        </div>
        <!-- this only for displays -->
        <!-- this only for displays -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title fw-bold" id="exampleModalLabel">EMAIL ME WHEN AVAILABLE</h5>
          ...
          <!--</div>-->
          <div class="col-12 input-group mb-3 text-center">
              <span class="input-group-text" id="basic-addon1">E-Mail</span>
              <input type="email" class="form-control col-12" style="border: 1px solid #ced4da;"
              placeholder="Email Address" aria-label="Email Address">
          </div>
          <div class="col-12 text-center mb-3">
            <button type="button" class="btn col-6" style="background:red; color:white;">Notify me</button>
          </div>
        </div>
      </div>
    </div>
