        ...
        <div class="col-12 ">
          ...
          <div class="col-10 text-center mt-3 m-auto"
            style="padding: 1rem;border-radius: 10px;box-shadow: 0px 0px 10px black;">
              ...
              <div class="container form-floating mb-3 mt-2 w-100"><input type="password" class="form-control ps-4" name="newPass" id="newPass"><label class="ms-4" for="floatingInput">Old-Password</label></div>
