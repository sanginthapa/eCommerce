...
<div class="col-12">
  <div class="col-12">
    <img class="w-100" style="height:400px" src="assets\images\products\27w charger\sleeping 2.png" alt="offer zone">
  </div>
  <div>

    <div class="container text-left mt-5 mb-5">
      <div class="h1 fw-bolder text-white"> <span class="border-bottom border-3 px-3">Mobile Charger</span></div>
    </div>
    <div style="background-color:black;" class=" col-12 d-flex flex-wrap ">
      <?php
      // extracting data from product table
// extracting data from product table
      $sql = "SELECT id,LEFT(product_name,15)as trunkName,product_name,category_id,actual_Price,sell_Price,img_path,primary_image,secondary_image,url_link,remarks FROM products";
      $conn = connectdb();
