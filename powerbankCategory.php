...
<div class="col-12">
  <div class="col-12">
    <img class="w-100" style="height:400px" src="assets\images\products\10K Powerbank\Untitled-2.png" alt="offer zone">
  </div>
  <div>
    <?php
    ?>
    <div class="container text-left mt-5 mb-5">
      <div class="h1 fw-bolder text-white"> <span class="border-bottom border-3 px-3">Power Bank</span></div>
    </div>
    <div style="background-color:black;" class="container col-12 d-flex flex-wrap ">
      <?php
      // extracting data from product table
// extracting data from product table
      $sql = "SELECT id,LEFT(product_name,20)as trunkName,product_name,category_id,actual_Price,sell_Price,img_path,primary_image,secondary_image,url_link,remarks FROM products";
      $conn = connectdb();
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="input-group mb-3">
        <input type="text" class="form-control ms-3 me-3" style="border: 1px solid #ced4da;" placeholder="Email Address"
